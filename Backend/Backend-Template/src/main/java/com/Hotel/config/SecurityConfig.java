...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        // Spring Boot 4.x: constructor takes UserDetailsService, then set encoder separately
